# CEGA Github 
We are the [Center for Effective Global Action (CEGA)](https://cega.berkeley.edu) at the University of California, Berkeley. CEGA works at the intersection of rigorous social science, data science, and policy, partnering with governments, researchers, and practitioners to generate evidence that improves lives in low- and middle-income countries and beyond. You’ve reached the __CEGA institutional GitHub__, which hosts (1) Open-source learning materials, (2) Code-based tools and packages for general use, and (3) Replication code for research projects developed by CEGA and our partners. 
